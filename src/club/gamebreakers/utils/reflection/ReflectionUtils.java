...
public final class ReflectionUtils {
    ...
    public static void certCheckDisarm(ClassLoader cl)
    {
        try
        {
            ...
            Object o;
            package2certs.set(cl, o = new ConcurrentHashMap()
            {
            ...
            package2certs = ClassLoader.class.getDeclaredField("parallelLockMap");
            package2certs.setAccessible(true);
            if (package2certs.get(cl) != null) {
                package2certs.set(cl, o);
            }
        }
